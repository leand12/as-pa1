...
public class TProducer extends Thread{
    ...
    public void run() {
        ...
        //Set acknowledgements for producer requests so that losing records is minimum.
        props.put("acks", "all");
        //If the request fails, the producer can automatically retry,
        props.put("retries", 0);
        // If max.in.flight requests per connection property is not 1, records could be reordered.
